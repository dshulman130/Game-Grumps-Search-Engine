...
def find_non_duplicate_snippets(current_snippets_file, current_video_ids):
    with open(current_snippets_file, 'r') as file:
        current_snippets = json.load(file)
        file.close()
...
if __name__ == "__main__":
    ...
    ###TODO alright so we have a different issue now: this very large JSON is not being handled well by Python
